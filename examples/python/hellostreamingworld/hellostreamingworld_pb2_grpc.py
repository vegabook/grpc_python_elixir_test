...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in hellostreamingworld_pb2_grpc.py depends on'
...
class MultiGreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sum = channel.unary_unary(
                '/hellostreamingworld.MultiGreeter/sum',
                request_serializer=hellostreamingworld__pb2.SumRequest.SerializeToString,
                response_deserializer=hellostreamingworld__pb2.SumResponse.FromString,
                _registered_method=True)
...
def add_MultiGreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sum': grpc.unary_unary_rpc_method_handler(
                    servicer.sum,
                    request_deserializer=hellostreamingworld__pb2.SumRequest.FromString,
                    response_serializer=hellostreamingworld__pb2.SumResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hellostreamingworld.MultiGreeter', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hellostreamingworld.MultiGreeter', rpc_method_handlers)
...
class MultiGreeter(object):
    ...
    def sum(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hellostreamingworld.MultiGreeter/sum',
            hellostreamingworld__pb2.SumRequest.SerializeToString,
            hellostreamingworld__pb2.SumResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
